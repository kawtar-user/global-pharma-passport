...
def list_drug_products(
    ...
    return medication_service.list_drug_products(db, query=query, country_code=country_code)
...
def list_my_medications(
    ...
    return medication_service.list_patient_medications(db, current_user)
...
def create_my_medication(
    ...
    return medication_service.create_patient_medication(db, current_user, payload)
...
def update_my_medication(
    ...
    return medication_service.update_patient_medication(db, current_user, medication_id, payload)
